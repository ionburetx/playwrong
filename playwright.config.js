...
export default defineConfig({
  ...
  use: {
    ...
    baseURL: 'http://localhost:5174', // He descomentado esta linea y cambiado la URL 'http://127.0.0.1:3000'
  ...
  webServer: {
    ...
    timeout: 120000, // Wait up to 2 minutes for the server to be ready
